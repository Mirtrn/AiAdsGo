...
CREATE TABLE IF NOT EXISTS offer_keyword_pools (
  ...
  -- 独占层：语义分桶
  bucket_a_keywords JSONB NOT NULL DEFAULT '[]'::jsonb,  -- 产品导向
  bucket_b_keywords JSONB NOT NULL DEFAULT '[]'::jsonb,  -- 场景导向
  bucket_c_keywords JSONB NOT NULL DEFAULT '[]'::jsonb,  -- 需求导向
...
BEGIN
    IF NOT EXISTS (
        ...
        -- 添加店铺分桶意图描述
        ALTER TABLE offer_keyword_pools ADD COLUMN IF NOT EXISTS store_bucket_a_intent TEXT DEFAULT '品牌信任导向';
        ALTER TABLE offer_keyword_pools ADD COLUMN IF NOT EXISTS store_bucket_b_intent TEXT DEFAULT '场景解决导向';
        ALTER TABLE offer_keyword_pools ADD COLUMN IF NOT EXISTS store_bucket_c_intent TEXT DEFAULT '精选推荐导向';
        ALTER TABLE offer_keyword_pools ADD COLUMN IF NOT EXISTS store_bucket_d_intent TEXT DEFAULT '信任信号导向';
        ALTER TABLE offer_keyword_pools ADD COLUMN IF NOT EXISTS store_bucket_s_intent TEXT DEFAULT '店铺全景导向';
...
INSERT INTO migration_history (migration_name) VALUES
  ('064_consolidated_schema_changes.pg.sql 065_consolidated_prompt_ad_creative.pg.sql 066_consolidated_prompt_analysis.pg.sql 067_fix_prompt_missing_variables.pg.sql 068_sync_prompt_versions.pg.sql 069_deprecate_keywords_generation_prompt.pg.sql 070_keyword_pools_and_prompts.pg.sql 071_rename_product_to_brand_oriented.pg.sql 072_add_synthetic_bucket.pg.sql 073_update_review_analysis_prompt_v3.3.pg.sql 074_launch_scores_creative_link.pg.sql 075_fix_global_keywords_schema.pg.sql 076_update_all_prompts_v4.14.pg.sql 077_enhance_audit_system.pg.sql 078_fix_boolean_columns.pg.sql 079_update_gemini_model_config.pg.sql 080_launch_score_v4.15_prompt_activation.pg.sql 081_launch_score_v4.16_matchtype_scoring.pg.sql 082_add_negative_keyword_matchtype.pg.sql 083_update_queue_config_campaign_publish.pg.sql 084_add_system_settings_unique_constraint.pg.sql 085_add_missing_proxy_urls_template.pg.sql 086_fix_system_settings_unique_constraint.pg.sql 087_restore_global_templates.pg.sql 088_add_bucket_d_to_keyword_pools.pg.sql 089_add_bucket_d_to_ad_creatives.pg.sql 090_update_keyword_intent_clustering_v4.15.pg.sql 091_092_093_update_prompts_v4.15.pg.sql 092_sync_competition_data_to_global_keywords.pg.sql 094_add_batch_cancellation.pg.sql 095_create_google_ads_service_accounts.pg.sql 096_update_ad_creative_generation_v4.15.pg.sql 097_ad_creative_types_optimization.pg.sql 098_add_store_keyword_buckets.pg.sql 099_keyword_clustering_v4.16.pg.sql 100_keyword_clustering_v4.17.pg.sql 101_ad_creative_generation_v4.17_final.pg.sql 102_fix_generated_buckets_inconsistency.pg.sql 103_keyword_clustering_v4.18_enhanced.pg.sql 104_fix_timestamp_columns.pg.sql 105_strict_json_format_constraint.pg.sql 106_sitelinks_count_6.pg.sql 107_single_product_focus_prompt_v4.18.pg.sql 108_fix_google_ads_account_id_on_delete.pg.sql 108_product_model_emphasis_v4.19.pg.sql 109_create_offer_blacklist.pg.sql 110_bucket_type_differentiation_v4.20.pg.sql 111_prompt_v4.21_store_link_sitelink_optional.pg.sql 112_prompt_v4.22_reduce_product_model_emphasis.pg.sql 113_prompt_v4.25_headline_diversity_and_bucket_adaptation.pg.sql 114_prompt_v4.26_clean.pg.sql 115_prompt_v4.30_final.pg.sql 116_prompt_v4.31_ad_strength_optimization.pg.sql 117_prompt_v4.32_brand_coverage_optimization.pg.sql 118_click_farm_tasks.pg.sql 119_drop_ad_performance_table.pg.sql 120_user_sessions.pg.sql 121_auto_sync_batch_status.pg.sql 122_combined_migration.pg.sql 123_add_soft_delete_to_core_tables.pg.sql 124_add_click_farm_referer_config.pg.sql 125_gemini_api_keys_and_provider_templates.pg.sql 126_add_currency_to_campaign_performance.pg.sql 127_fix_click_farm_tasks_foreign_key.pg.sql 128_create_url_swap_tasks.pg.sql 129_add_consecutive_failures.pg.sql 130_update_prompts_enhanced_data.pg.sql 131_add_enhanced_extraction_fields.pg.sql 132_remove_risk_type_column.pg.sql 133_add_data_sync_global_templates.pg.sql 134_fix_url_swap_offer_unique_soft_delete.pg.sql 135_add_google_ads_test_credentials.pg.sql 136_add_google_ads_accounts_identity_verification.pg.sql 137_add_offer_tasks_brand_name.pg.sql 138_add_campaign_published_at.pg.sql 139_ad_creative_generation_v4.34.pg.sql 140_ad_creative_generation_v4.35.pg.sql ')
