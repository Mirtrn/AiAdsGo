...
BEGIN
  ...
  RAISE NOTICE 'Part 2.2: Data Validation - Campaigns without is_deleted field: %', null_count;
  ...
  RAISE NOTICE 'Part 2.2: Statistics - Soft-deleted campaigns: %', deleted_campaigns;

  SELECT COUNT(*) INTO deleted_offers
  FROM offers
  WHERE is_deleted = TRUE;

  RAISE NOTICE 'Part 2.2: Statistics - Soft-deleted offers: %', deleted_offers;
  ...
  RAISE NOTICE 'Part 2.2: Performance data for deleted campaigns: %', perf_count;
END $$;
