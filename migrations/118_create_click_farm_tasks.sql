-- Migration: 118_create_click_farm_tasks
-- Description: 创建补点击任务表（Click Farm Tasks）
-- SQLite版本
-- Author: Claude
-- Date: 2024-01-15
...
CREATE TABLE IF NOT EXISTS click_farm_tasks (
  ...
  pause_reason TEXT,  -- no_proxy / manual / null
  pause_message TEXT,
  paused_at TEXT,
  ...
  -- 示例: [{"date": "2024-01-15", "target": 216, "actual": 210, "success": 205, "failed": 5}]
