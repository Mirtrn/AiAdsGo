...
-- 11. optimization_recommendations表 - 优化建议
...
-- 13. campaign_performance表 - 广告系列性能数据
...
-- 18. cpc_adjustment_history表 - CPC调整历史
...
-- 23. creative_learning_patterns表 - 创意学习模式
...
-- 28. google_ads_credentials表 - Google Ads凭证
...
-- 29. google_ads_api_usage表 - Google Ads API使用统计
...
-- 30. ad_strength_history表 - Ad Strength历史
...
-- 31. industry_benchmarks表 - 行业基准数据
...
-- 32. ad_creative_performance表 - 广告创意效果数据
...
-- 33. conversion_feedback表 - 用户转化反馈
...
-- 34. score_analysis_history表 - 评分分析历史
...
-- 35. ai_token_usage表 - AI Token使用统计
...
-- 36. prompt_versions表 - Prompt版本管理
...
-- 37. prompt_usage_stats表 - Prompt使用统计
