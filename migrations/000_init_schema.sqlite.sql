...
VALUES (NULL, 'google_ads', 'client_id', 'string', 1, 1, NULL, 'Google Ads API Client ID');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'google_ads', 'client_secret', 'string', 1, 1, NULL, 'Google Ads API Client Secret');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'google_ads', 'developer_token', 'string', 1, 1, NULL, 'Google Ads Developer Token');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'ai', 'gemini_api_key', 'string', 1, 0, NULL, 'Gemini API密钥（直接API模式）');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'ai', 'gemini_model', 'string', 0, 1, 'gemini-2.5-pro', 'Gemini模型版本');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'ai', 'use_vertex_ai', 'boolean', 0, 0, 'false', '是否使用Vertex AI（优先于直接API）');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'ai', 'gcp_project_id', 'string', 1, 0, NULL, 'GCP项目ID（Vertex AI）');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'ai', 'gcp_location', 'string', 0, 0, 'us-central1', 'GCP区域（Vertex AI）');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'ai', 'gcp_service_account_json', 'text', 1, 0, NULL, 'GCP Service Account JSON（Vertex AI）');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'proxy', 'urls', 'json', 0, 0, NULL, '代理URL配置列表（JSON格式），支持多个国家的代理URL');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'system', 'currency', 'string', 0, 1, 'CNY', '默认货币');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'system', 'language', 'string', 0, 1, 'zh-CN', '系统语言');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'system', 'sync_interval_hours', 'number', 0, 1, '6', '数据同步间隔(小时)');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'system', 'link_check_enabled', 'boolean', 0, 1, 'true', '是否启用链接检查');
INSERT OR IGNORE INTO system_settings (user_id, category, config_key, data_type, is_sensitive, is_required, default_value, description)
VALUES (NULL, 'system', 'link_check_time', 'string', 0, 1, '02:00', '链接检查时间');
