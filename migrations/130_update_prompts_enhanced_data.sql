...
INSERT INTO prompt_versions (
  ...
  'src/lib/ai.ts',
  'analyzeBrandStore',
  'You are a professional brand analyst. Analyze the BRAND STORE PAGE data.
...
INSERT INTO prompt_versions (
  ...
  'You are a professional Google Ads copywriter. Generate 4 ad descriptions (max 90 chars each).
...
INSERT INTO prompt_versions (
  ...
  'src/lib/ad-elements-extractor.ts',
  'generateHeadlines',
  'You are a professional Google Ads copywriter. Generate 15 ad headlines (max 30 chars each).
...
INSERT INTO prompt_versions (
  ...
  'You are a product marketing expert. Synthesize product highlights from {{productCount}} products into 5-8 store-level highlights.
