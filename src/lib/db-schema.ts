...
export const TABLES: TableDef[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    columns: [
      ...
      { name: 'impressions_total', type: 'BIGINT', notNull: true, default: 0 },
      { name: 'clicks_total', type: 'BIGINT', notNull: true, default: 0 },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    columns: [
      ...
      { name: 'keyword_norm', type: 'TEXT', notNull: true },
      { name: 'date', type: 'DATE', notNull: true },
      { name: 'impressions', type: 'BIGINT', notNull: true, default: 0 },
      { name: 'clicks', type: 'BIGINT', notNull: true, default: 0 },
      { name: 'source_mask', type: 'TEXT', notNull: true },
      { name: 'created_at', type: 'TIMESTAMP', notNull: true, default: 'CURRENT_TIMESTAMP' },
    ],
    indexes: [
