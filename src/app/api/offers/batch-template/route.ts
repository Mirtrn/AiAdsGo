...
export async function GET() {
  ...
  const csv = `\uFEFF${[
    '推广链接,推广国家,链接类型,品牌名,产品价格/平均产品价格,佣金比例/平均佣金比例,单品推广链接1,单品推广链接2,单品推广链接3',
    'https://pboost.me/UKTs4I6,US,product,kaspersky,$699.00,6.75%,,,',
    'https://pboost.me/xEAgQ8ec,DE,product,,€299.00,8.00%,,,',
    'https://pboost.me/RKWwEZR9,UK,product,,£499.00,7.50%,,,',
    'https://example-affiliate-store.com,US,store,BrandX,$59.00,12%,https://example.com/item-a,https://example.com/item-b,https://example.com/item-c',
    '',
  ].join('\r\n')}`
