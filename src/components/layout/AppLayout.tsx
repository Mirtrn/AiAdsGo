...
export default function AppLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 dark:bg-slate-900 lg:pb-0 pb-16">
      ...
      <aside
        className={`
          hidden lg:block fixed top-0 left-0 h-full bg-slate-900 z-40 transition-all duration-300 shadow-xl
      ...
      >
        ...
        <div className="px-3 mb-5">
          <button
            ...
            className={`
              ...
              ${sidebarOpen ? 'bg-white/5 hover:bg-white/10 border border-white/10' : 'justify-center hover:bg-white/10'}
            `}
          >
              ...
              <>
                <div className="flex-1 min-w-0 text-left">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <p className="text-xs text-slate-400">{user.packageType}</p>
                  </div>
                </div>
        ...
        {/* Navigation */}
        <nav className="px-3 space-y-0.5 flex-1 overflow-y-auto custom-scrollbar" style={{ maxHeight: 'calc(100vh - 200px)' }}>
          {sidebarOpen && (
          ...
          {mainNavigationItems.map((item) => {
            ...
            return (
              ...
              >
                <Icon className={`w-[18px] h-[18px] flex-shrink-0 transition-colors ${active ? 'text-white' : 'text-slate-500 group-hover:text-slate-300'}`} />
          ...
          {sidebarOpen && advancedNavigationItems.length > 0 && (
            <div className="pt-3">
              <button
                ...
                className="w-full flex items-center justify-between px-2 py-1.5 rounded-lg text-slate-500 hover:text-slate-300 transition-all duration-200"
