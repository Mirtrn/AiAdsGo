      ...
      >
        ...
        <nav className="px-3 space-y-0.5 flex-1 overflow-y-auto custom-scrollbar" style={{ maxHeight: 'calc(100vh - 200px)' }}>
          ...
          {mainNavigationItems.map((item) => {
            ...
            return (
              ...
              >
                <Icon className={`w-[18px] h-[18px] flex-shrink-0 transition-colors ${active ? 'text-white' : 'text-slate-500 group-hover:text-slate-700'}`} />
          ...
          {sidebarOpen && advancedNavigationItems.length > 0 && (
            <div className="pt-3">
              <button
                ...
                className="w-full flex items-center justify-between px-2 py-1.5 rounded-lg text-slate-500 hover:text-slate-700 transition-all duration-200"
        ...
        <div className="p-3 border-t border-slate-200">
          <Button
            ...
            className={`
              w-full flex items-center gap-3 text-slate-500 hover:text-red-500 hover:bg-red-50 transition-colors
              ${!sidebarOpen && 'justify-center'}
            `}
          >
